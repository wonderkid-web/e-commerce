            ...
            <div className="mt-4 px-5 pb-5">
              <a href="#">
                <h5 className="text-xl tracking-tight text-slate-900">
                  Nike. Air Jordan GTX-9010
                </h5>
              </a>
              <div className="mt-2 mb-5 flex items-center justify-between">
                <p>
                  <span className="text-xl font-bold text-slate-900">Rp. {d.harga}</span>
                </p>
                <p>
                  <span className="p-4 rounded-md text-white font-bold bg-indigo-900">{d.stock}</span>
                </p>
              </div>
              <Link
                href={`/pembeli/produk/${d.id}`}
