        ...
        <nav className="flex justify-between bg-indigo-800 text-white w-screen">
          <div className="px-5 xl:px-12 py-6 flex w-full items-center">
            ...
            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12 relative -left-4">
              <li>
                <Link className="hover:text-gray-200  p-2 rounded hover:bg-indigo-950" href="/penjual/form-produk">
                  Tambah Produk
                </Link>
              </li>
              <li>
                <Link className="p-2 rounded hover:text-gray-200  hover:bg-indigo-950" href="/penjual/list-produk">
                  Listing Produk
                </Link>
              </li>
            </ul>
